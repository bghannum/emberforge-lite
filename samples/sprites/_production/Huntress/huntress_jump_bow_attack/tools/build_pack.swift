...
// The generated release dropped the nocked arrow for frame 7. Hold the preceding
// fully drawn pose for one frame, then transition to the separate flying arrow.
frames[7] = frames[6]
